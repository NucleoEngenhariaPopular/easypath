"""
Logging configuration for the Messaging Gateway service.
...
def setup_logging(log_level: str = "INFO", log_dir: str = "logs"):
    ...
    file_handler = logging.handlers.RotatingFileHandler(
        filename=log_path / "messaging-gateway.log",
    ...
    error_handler = logging.handlers.RotatingFileHandler(
        filename=log_path / "messaging-gateway-errors.log",
        maxBytes=10 * 1024 * 1024,  # 10 MB
        backupCount=5,
        encoding='utf-8'
    )
    ...
    logger.info(f"Log files: {log_path / 'messaging-gateway.log'}, {log_path / 'messaging-gateway-errors.log'}")
