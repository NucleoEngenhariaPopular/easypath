...
CREATE TABLE IF NOT EXISTS bot_configs (
    ...
    platform VARCHAR(50) NOT NULL,  -- 'telegram', 'whatsapp', 'sms'
...
CREATE INDEX idx_bot_configs_owner ON bot_configs(owner_id);
CREATE INDEX idx_bot_configs_platform ON bot_configs(platform);
